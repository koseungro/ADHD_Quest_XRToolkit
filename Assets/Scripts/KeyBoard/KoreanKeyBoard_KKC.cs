...
{
    public class KoreanKeyBoard_KKC : MonoBehaviour
    {        
        public List<GameObject> OffObject = new List<GameObject>();
        public List<KoreanKey_KKC> KeyList = new List<KoreanKey_KKC>();
        ...
        public List<KoreanKey_KKC> KorGOList = new List<KoreanKey_KKC>();
        public List<KoreanKey_KKC> NumberGOList = new List<KoreanKey_KKC>();
        ...
        public ShiftState_KKC isShift = ShiftState_KKC.OFF;
        public KoreanState_KKC isKor = KoreanState_KKC.KOR;
        ...
        public void LoadKeyData(ShiftState_KKC isShift, KoreanState_KKC isKor = KoreanState_KKC.KOR)
        {
            for (int i = 0; i < KeyList.Count; i++)
            {
        ...
        public void Test(string text, bool isFunctionKey = false)
        {
            ...
            if (isFunctionKey)
            {
                ...
                else if (text.Equals("Shift"))
                {
                    ...
                    if (isShift == ShiftState_KKC.OFF)
                    {
                        isShift = ShiftState_KKC.ON;
                        LoadKeyData(isShift, isKor);
                    }
                    else if (isShift == ShiftState_KKC.ON)
                    {
                        isShift = ShiftState_KKC.OFF;
                        LoadKeyData(isShift, isKor);
                    }
                    return;
                }
                else if (text.Equals("ABC") || text.Equals("한글"))
                {
                    ...
                    if (isKor == KoreanState_KKC.KOR)
                    {
                        isKor = KoreanState_KKC.ENG;
                        LoadKeyData(isShift, isKor);
                    }
                    else if (isKor == KoreanState_KKC.ENG)
                    {
                        isKor = KoreanState_KKC.KOR;
                        LoadKeyData(isShift, isKor);
                    }
                    return;
                }
        ...
        private string combine2(Word preWord, Word CurrentWord)
        {
            string ch = "";
