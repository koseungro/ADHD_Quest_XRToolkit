...
namespace CurvedUI {
    ...
    public class CUI_ControllerHandSwitcher : MonoBehaviour
    {
        ...
        void Update()
        {
            ...
            //}
            //else if (OVRInput.GetDown(CurvedUIInputModule.Instance.OculusTouchInteractionButton, OVRInput.Controller.LTrackedRemote) && CurvedUIInputModule.Instance.UsedHand != CurvedUIInputModule.Hand.Left)
            //{
            //    SwitchHandTo(CurvedUIInputModule.Hand.Left);
            //}
        }
